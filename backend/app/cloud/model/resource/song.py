...
class Song(Base):
    ...
    __tablename__ = 'u_song'
    __table_args__ = (sa.Index('idx_song_album_id', 'album_id'), {'comment': '歌曲表。'})
    ...
    album_id: Mapped[int | None] = mapped_column(
        sa.ForeignKey('u_song_album.id', ondelete='RESTRICT'), default=None, comment='歌曲专辑 ID',
    )
