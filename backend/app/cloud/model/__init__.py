...
from backend.app.cloud.model.device.device import Device as Device
from backend.app.cloud.model.device.device_recharge import DeviceRecharge as DeviceRecharge
