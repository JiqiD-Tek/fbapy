...
from backend.app.cloud.crud.crud_feedback import feedback_dao
...
class FeedbackService:
    ...
    async def get_list(
        *,
        ...
        """获取反馈列表（支持分页和查询条件）"""
        feedback_select = await feedback_dao.get_select(name=name, device_did=device_did, status=status)
