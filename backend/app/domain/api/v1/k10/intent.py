...
from backend.app.domain.schema.intent import WeatherParam, MusicParam, ControlParam
...
@router.post('/music', summary='音乐播放')
async def music_intent(
    ...
    await messaging_service.send_play_music(song=obj.song, album=obj.album, singer=obj.singer, query=obj.query)
