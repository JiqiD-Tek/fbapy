...
from backend.app.iot.model import Feedback
from backend.app.iot.schema.feedback import CreateFeedbackParam, UpdateFeedbackParam
...
class CRUDFeedback(CRUDPlus[Feedback]):
    ...
    async def get_select(self, name: str | None, did: str | None, status: int | None) -> Select:
        filters = {}
