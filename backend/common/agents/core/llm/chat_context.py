...
from backend.common.agents.core.utils.misc import shortuuid, is_given
from backend.common.agents.core.utils._types import NOT_GIVEN, NotGivenOr

if TYPE_CHECKING:
    from backend.common.agents.core.llm import LLM, FunctionTool, ProviderTool, RawFunctionTool
...
ChatContent: TypeAlias = Union[str]
